const Levels =
{
    "level1": {
        ...
        "gMap": [
            ...
            ['w','w','w','g','w','g','g','w','w','g','w','g','w','w','g','w','g','g','g','f','g','w','g','w','w','f','w','g','g','w'],
    ...
    "level2": {
        ...
        "gMap": [
            ['w','o','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w','w'],
            ['w','g','w','w','f','w','g','w','w','w','w','g','g','f','g','w','w','w','w','w','c','g','w','g','g','w','w','c','w','w'],
            ['w','f','w','g','g','w','g','g','g','g','g','g','w','w','g','w','w','g','g','w','w','g','g','g','g','w','g','g','g','w'],
            ['w','f','w','w','g','g','g','w','g','w','w','g','w','w','g','g','g','g','g','w','w','w','w','g','g','w','g','w','g','w'],
            ['w','g','g','g','g','w','w','w','g','w','g','g','w','w','g','w','w','g','g','f','g','g','w','w','g','w','w','w','g','w'],
...
let loadNextLevel = function(p) {
    p.level = 'level' + (1 + parseInt(p.level.slice(-1)));
    p.posX = p.posY = 1;
